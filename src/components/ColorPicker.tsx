...
const ColorPicker = ({ className, placeholder, value, valid = true, onChange, onFocus, onBlur }: ColorPickerProps) => {
  ...
  return (
    <Wrapper as='div' valid={valid} className={className} active={isActive} onClick={handleTextFocus}>
      <input
        ref={textRef}
